...
**2.&nbsp; [Rho-1:&nbsp;Not All Tokens Are What You Need](https://arxiv.org/abs/2404.07965)** <br>

## Benchmark Comparison<br>

The baseline model `TinyLlama/TinyLlama-1.1B-intermediate-step-1431k-3T` was evaluated on the exact set of benchmark tasks used by the Rho-1 authors. The comparison results are shown in the table below.<br>
...
## Continual Pretraining (CPT) Results<br>

Performed continual pretraining (CPT) of TinyLlama-1.1B on the OpenWebMath dataset following the RHO-1 study. The table below compares our CPT results with the results reported by the RHO-1 authors.<br>
| Evaluation | GSM8K | SVAMP | ASDiv | MAWPS | TAB | MQA | MMLU STEM | SAT‡ | MATH |
|------------|-------|-------|-------|-------|-----|-----|-----------|------|------|
